...
def lose():
        ...
        temp.pendown()
        temp.write("This was the vocabulary:",align="left", font=("Arial", 30, "bold"))
        ...
        if(user_input in movie and user_input not in user_list_correct):
            ...
            for i in range(len(movie)):
                if(movie[i]==user_input):
                    letter[i].write(user_input.lower(),align="left", font=("Arial", 20, "bold"))
...
assert isinstance(wn.bgpic, object)
wn.bgpic("imain.gif")
wn.tracer(2)
Hangman(0)
